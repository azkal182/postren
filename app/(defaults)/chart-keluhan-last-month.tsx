...
const ChartKeluhanLastMonth = ({ data }: { data: any }) => {
    ...
    return (
        <div className="panel">
            <h1 className="text-center font-semibold text-dark dark:text-dark-light">Grafik SAKIT Bulan {bulan[month]?.toUpperCase()}</h1>
            <div className="">
                {isMounted && (
...
export default ChartKeluhanLastMonth;
